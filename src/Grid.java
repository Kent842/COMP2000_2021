...
class Grid {
  ...
  ArrayList<ArrayList<Environment>> environment = new ArrayList<ArrayList<Environment>>(); // Array of all the
                                                                                           // environment blocks being
                                                                                           // painted
  ...
  public Optional<Environment> cellAtPoint(Point p) { //Returns the cell at the cursor
    for (int i = 0; i < 20; i++) {
      for (int j = 0; j < 20; j++) {
